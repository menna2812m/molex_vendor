<template>
  <Pageheader heading="Pages" maintitle="aboutus" subtitle="Pages" />
  <div class="container">
    <!-- Row-->
    ...
    <div class="row row-sm">
      <div class="col-xl-12">
        <div class="card custom-card">
          <img src="../../../assets/img/media/team.jpg" alt="img" class="rounded-6" />
        </div>
      </div>
    </div>
    <!-- End Row -->
      ...
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="row row-sm">
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="mt-5">
              <h3 class="mb-3">
                Creative <span class="text-primary">Design</span> for a Bright Future.
              </h3>
              <p>
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="text-xl-end text-center">
              <img src="../../../assets/img/media/team.png" alt="img" class="rounded-6" />
            </div>
          </div>
        </div>
      </div>
...
C21.51917,17.15436,19.06299,14.05371,15.70056,12.71338z"
              ...
              <div class="ms-4">
                ...
                <p>
                  ...
                  sint, officia vel ab perferendis, dolores placeat dolor aliquam debitis
                  eius, illum ullam ratione blanditiis fugiat omnis beatae odio vitae!
                </p>
              </div>
            </div>
            <div class="d-flex mb-4">
...
C14.46332,13.47485,14.72839,13.5,15,13.5c2.76007-0.00323,4.99677-2.23993,5-5C20,5.73859,17.76141,3.5,15,3.5z"
              ...
              <div class="ms-4">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quos
                  sint, officia vel ab perferendis illum ullam ratione blanditiis fugiat
                  omnis beatae odio vitae!
                </p>
              </div>
            </div>
            <div class="d-flex">
          ...
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg
                  class="statistics-icon bg-secondary-light"
                  xmlns="http://www.w3.org/2000/svg"
                  enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24"
                >
        ...
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg
                  class="statistics-icon bg-warning-light"
                  xmlns="http://www.w3.org/2000/svg"
                  enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24"
                >
        ...
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg
                  class="statistics-icon bg-danger-light"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                  <path
        ...
        <div class="card custom-card bg-primary-transparent">
          <div class="card-body">
            <div class="counter-status">
              <div class="text-center mb-1">
                <svg
                  class="statistics-icon bg-info-light"
                  xmlns="http://www.w3.org/2000/svg"
                  enable-background="new 0 0 24 24"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="card-body">
            ...
            <div class="text-center mt-3">
              <router-link :to="`${url}pages/profile`"
                ><h5 class="pro-user-username text-dark mt-2 mb-0">
                  Dennis Trexy
                </h5></router-link
              >
            ...
            <div class="text-center mt-3">
              <a
                ...
                target="_blank"
                class="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1"
                ><i class="mdi mdi-facebook"></i
              ></a>
              <a
                href="https://myaccount.google.com/"
                target="_blank"
                class="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1"
                ><i class="mdi mdi-google"></i
              ></a>
              <a
                href="https://twitter.com/"
                target="_blank"
                class="btn btn-sm ripple bg-info-transparent text-info rounded-circle"
