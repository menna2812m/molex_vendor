<template>
  <!-- Row -->
  <Pageheader heading="Pages" maintitle="settings" subtitle="Pages" />
        ...
        <div class="card-header">
          <div>
            <h3 class="card-title tx-18">
              <label class="main-content-label tx-15">Settings</label>
            </h3>
          </div>
        </div>
        <div class="card-body">
          <div class="main-content-left main-content-left-mail">
            <div class="main-mail-menu">
              <nav class="nav main-nav-column mg-b-20">
                <a class="nav-link thumb active mb-2" href="javascript:void(0)"
                  ><i class="fe fe-user"></i> Account
                </a>
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-lock"></i> Privacy & Security</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-edit-2"></i> General</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-info"></i> Help & Support</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-mail"></i> Emails</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-flag"></i> Language & Region</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-bell"></i> Notifications</a
                >
                <a class="nav-link thumb mb-2" href="javascript:void(0)"
                  ><i class="fe fe-settings"></i> Blog</a
                >
              </nav>
            </div>
          </div>
        ...
        <div class="col-xl-6">
          <div class="card custom-card">
                  ...
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <p class="tx-13 text-muted mb-0">
                        Dashboard Settings such as sidemenu,header and main page can be
                        Controlled.
                      </p>
                    </div>
                  </div>
            ...
            <div class="card-footer rounded-0">
              <a href="javascript:void(0)" class="tx-14 mb-0 d-block d-sm-inline-flex">Go to Settings</a>
              <label class="custom-switch float-sm-end mb-0">
                <a href="javascript:void(0)" class="tx-14 mb-0 me-2 text-dark"
                  >Restore default</a
                >
                <input
                  type="checkbox"
                ...
                <div class="col-lg-12">
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <p class="tx-13 text-muted mb-0">
                        Web apps settings such as Apps,Elements,Advanced Ui & Mail can be
                        Controlled.
                      </p>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="d-flex">
                    ...
                    <div>
                      <h5 class="tx-14 d-flex text-dark tx-uppercase">
                        Language & Region
                      </h5>
                      <p class="tx-13 text-muted mb-0">
                ...
                <div class="col-lg-12">
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <p class="tx-13 text-muted mb-0">
                        Notification settings we can control the notification privacy and
                        security.
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-lg-12">
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <p class="tx-13 text-muted mb-0">
                        In this settings we can modify all Blog related settings in this
                        template.
                      </p>
                    </div>
                  </div>
