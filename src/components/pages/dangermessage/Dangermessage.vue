<template>
  <div class="page main-signin-wrapper bg-primary br-0-f">
    <div class="d-flex header-setting-icon demo-icon fa-spin">
      <a class="nav-link icon" href="javascript:;" v-on:click="Switcherfbutton">
        <i class="fe fe-settings settings-icon"></i>
      </a>
    </div>

    <!-- Row -->
    <div class="row signpages ext-center" v-on:click="Remove">
          ...
          <div class="card-body">
            <div class="text-center text-white">
              ...
              >
                ...
                />
                <path
                  d="m114 105c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10z"
                />
              </svg>
              <h3 class="mt-4 mb-3">Message Danger</h3>
              <p class="tx-18 text-white-50">
                Oops!! You tried to access a page which is not available.
              </p>
              <router-link
                :to="`${url}admin`"
                class="btn ripple btn-danger text-center"
                routerLink="/admin"
