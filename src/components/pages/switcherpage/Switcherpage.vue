<template>
  <Pageheader heading="Switcherpage" maintitle="Pages" subtitle="Switcherpage" />
  <div class="container">
        ...
        <div class="card custom-card sidebar-right1 switcher-2">
          ...
          <div class="card-body">
            <div class="switch_section text-center px-0">
              <div class="btn-list">
                <button class="btn btn-success w-lg me-0 me-sm-2">Save Settings</button>
                <button
                  class="btn btn-danger w-lg me-0 me-sm-2"
