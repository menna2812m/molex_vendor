<template>
  <!-- Row -->
  <Pageheader heading="Invoice" maintitle="Pages" subtitle="Invoice" />
  <div class="row row-sm">
    <div class="col-lg-12 col-md-12">
      <div class="card custom-card">
          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto">
              <p class="mb-1 text-end">
                <span class="font-weight-bold">Invoice Date :</span> 01st November 2020
              </p>
              <p class="mb-0 text-end">
                <span class="font-weight-bold">Due Date :</span> 01 May 2020
              </p>
            </div>
          </div>
          <hr class="mg-b-40" />
        ...
        <div class="card-footer text-end btn-list">
          <button type="button" class="btn ripple btn-primary mb-1">
            <i class="fe fe-credit-card me-1"></i> Pay Invoice
          </button>
          <button type="button" class="btn ripple btn-secondary mb-1">
            <i class="fe fe-send me-1"></i> Send Invoice
          </button>
          <button
            type="button"
            class="btn ripple btn-info mb-1"
