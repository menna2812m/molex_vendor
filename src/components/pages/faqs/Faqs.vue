<template>
  <Pageheader heading="Faqs" maintitle="Pages" subtitle="Faqs" />
    ...
    <div class="col-sm-12 col-md-12">
      <div class="card custom-card">
        <div class="card-body">
          ...
          <div class="border">
            <div class="p-4">
              <h5 class="font-weight-semibold tx-16">
                1. How To Insert All The Plugins?
              </h5>
              <p class="mb-0 tx-14 text-muted">
            ...
            <div class="p-4 border-top">
              <h4 class="font-weight-semibold tx-16">
            ...
            <div class="card">
              <div class="card-header" id="headingOne" role="tab">
                <a
                  ...
                  href="#collapseOne"
                  >1. How To Insert All The Plugins?</a
                >
              </div>
              <div
            ...
            <div class="card">
              <div class="card-header" id="headingThree" role="tab">
                <a
                  ...
                  data-bs-toggle="collapse"
                  href="#collapseThree"
                  >3. Can I use this Plugins in Another Template?</a
                >
              </div>
              <div
            ...
            <div class="card">
              <div class="card-header" id="headingfour" role="tab">
                <a
                  ...
                  data-bs-toggle="collapse"
                  href="#collapsefour"
                  >4. How Can I Add another page in Template?</a
                >
              </div>
              <div
            ...
            <div class="card">
              <div class="card-header" id="headingfive" role="tab">
                <a
                  ...
                  data-bs-toggle="collapse"
                  href="#collapsefive"
                  >5. It is Easy to Customizable?</a
                >
              </div>
              <div
            ...
            <div class="card">
              <div class="card-header" id="headingsix" role="tab">
                <a
                  ...
                  data-bs-toggle="collapse"
                  href="#collapsesix"
                  >6. How can I download This template?</a
                >
              </div>
              <div
